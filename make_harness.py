...
harness.write("\n// harness-agent.js\n")
f = open("./test262/implementation-contributed/v8/test262/harness-agent.js", "r")
harness.write(f.read())

harness.write("\n// harness-adapt-donotevaluate.js\n")
f = open("./test262/implementation-contributed/v8/test262/harness-adapt-donotevaluate.js", "r")
harness.write(f.read())

harness.write("\n// detachArrayBuffer.js\n")
f = open("./test262/implementation-contributed/v8/test262/detachArrayBuffer.js", "r")
harness.write(f.read())

harness.write("\n// propertyHelper.js\n")
f = open("./test262/harness/propertyHelper.js", "r")
harness.write(f.read())

harness.write("\n// atomicsHelper.js\n")
f = open("./test262/harness/atomicsHelper.js", "r")
harness.write(f.read())
