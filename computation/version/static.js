...
function parseJSON(){
    ...
    var program_text = readFileContent("../utils/esVersions.json")
...
var file = readFileContent("../official/results/metadata_test262.json");
...
for (var v in results)
{
    ...
    fs.writeFile("./results/static/"+v+".json", JSON.stringify(results[v]), function(){});
}
//writes the result in a file
fs.writeFile("./results/static/result.json", JSON.stringify(results), function(){});
